...
PAGE_SEO = {
    ...
    "termini-e-condizioni/index.html": {
        ...
        "description": "Termini di utilizzo del sito informativo Casa Famiglia Quercia. Quercia S.r.l.s., P.IVA IT13206680012, Pinerolo (TO). Legge italiana, foro di Torino.",
...
REPLACEMENTS = [
    ...
    ("Casa Famiglia Quercia", "Casa Famiglia Quercia"),
    ("Casa Famiglia Quercia", "Casa Famiglia Quercia"),
    ("Casa Famiglia Quercia", "Casa Famiglia Quercia"),
    ...
    ("| Casa Famiglia Quercia", "| Casa Famiglia Quercia"),
    ("Casa Famiglia Quercia – Pinerolo", "Casa Famiglia Quercia – Pinerolo"),
    ("Casa Famiglia Quercia – Pinerolo", "Casa Famiglia Quercia – Pinerolo"),
