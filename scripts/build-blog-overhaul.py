...
PROMO_BOXES = {
    "galleria": {
        ...
        "text": "Scoprite gli spazi di Casa Famiglia Castelletto: camere luminose, salotti accoglienti e giardino nel verde di Coazze.",
        "icon": "gallery",
    },
    "servizi": {
        "href": "/servizi/",
...
def sidebar_cta():
    return """<div class="blog-sidebar-box blog-sidebar-cta">
            <h2 class="blog-sidebar-box__title">Scopri Casa Famiglia Castelletto</h2>
...
def build_html(article):
    ...
    hero_caption = article.get("hero_caption", "Casa Famiglia Castelletto, Stradale Poirino 152 — Coazze, Valle di Susa")
    wa_text = unquote(article.get("wa_text", "Ciao, ho letto il vostro articolo e vorrei informazioni sulla casa famiglia"))
    author = article.get("author", "Casa Famiglia Castelletto")
...
def build_md(article):
    lines = [
        ...
        f'author: {article.get("author", "Casa Famiglia Castelletto")}',
    ...
    for slug in all_slugs:
        ...
        cards.append(f"""          <article class="card blog-card" data-category="{html_lib.escape(meta['category'])}">
            <a href="/blog/{slug}/" class="blog-card__image-link">
              <img src="../images/Coazze - Casa Famiglia Castelletto/{html_lib.escape(thumb)}" alt="{html_lib.escape(meta.get('thumb_alt', meta['title']))}" width="400" height="250" loading="lazy" class="blog-card__image">
            </a>
...
<head>
  ...
  <link rel="stylesheet" href="../css/pages.css">
  <link rel="stylesheet" href="../blog.css">
  <script type="application/ld+json">{{"@context":"https://schema.org","@type":"Blog","name":"Blog Casa Famiglia Castelletto","url":"{SITE}/blog/","description":"Guide per famiglie che scelgono una casa famiglia a Coazze","publisher":{{"@type":"Organization","name":"Casa Famiglia Castelletto"}}}}</script>
      ...
      <div class="container">
        <article class="blog-featured__card">
          <a href="/blog/{featured_slug}/" class="blog-featured__image-wrap">
            <img src="../images/Coazze - Casa Famiglia Castelletto/{html_lib.escape(featured_thumb)}" alt="{html_lib.escape(featured.get('hero_alt', featured['title']))}" width="1200" height="600" loading="eager" class="blog-featured__image">
          </a>
